...
public class AgricultureCropsWorkingDays {
	...
	private List<AgricultureCropsWorkingDaysResultData> years;
	...
	public List<AgricultureCropsWorkingDaysResultData> getYears() {
		return years;
	}

	public void setYears(List<AgricultureCropsWorkingDaysResultData> years) {
		this.years = years;
	}
