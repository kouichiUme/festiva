...
public class ResasHttpAccessTest {
	...
	public void testAgricultureSalesShippingRatio() throws ParseException, IOException {
		...
		String result = ResasHttpAccess.sendString("api/v1" + AgricultureSalesShipRatioRequest.url,
				params.toString());

		System.out.println(result);
		AgricultureSalesShipRatioResult resultData = om.readValue(result,
				AgricultureSalesShipRatioResult.class);
	...
	public void testAgricultureCropSales() throws ParseException, IOException {
		...
		String result = ResasHttpAccess.sendString("api/v1" + AgricultureCropsSalesRequest.url,
				params.toString());

		System.out.println(result);
		AgricultureCropsSalesResult resultData = om.readValue(result,
				AgricultureCropsSalesResult.class);
